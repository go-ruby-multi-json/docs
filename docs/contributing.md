...
Contributions are welcome. `go-ruby-multi-json/multi-json` is built to a small set of
...
The library is in [`github.com/go-ruby-multi-json/multi-json`](https://github.com/go-ruby-multi-json/multi-json).
This documentation site is in [`github.com/go-ruby-multi-json/docs`](https://github.com/go-ruby-multi-json/docs).
