# go-ruby-multi-json documentation

**Pure-Go multi_json — swappable JSON facade (CGO=0).**

`go-ruby-multi-json/multi-json` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `multi-json`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-multi-json/multi-json`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `multi-json`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-multi-json/multi-json
```
...
| Repo | What it is |
| --- | --- |
| [`multi-json`](https://github.com/go-ruby-multi-json/multi-json) | the library — Ruby's `multi-json` in pure Go |
| [`docs`](https://github.com/go-ruby-multi-json/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-multi-json.github.io`](https://github.com/go-ruby-multi-json/go-ruby-multi-json.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-multi-json/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-multi-json/multi-json](https://github.com/go-ruby-multi-json/multi-json).
