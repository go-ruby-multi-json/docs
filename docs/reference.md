...
The public API lives at the module root (`github.com/go-ruby-multi-json/multi-json`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `multi-json`, while the surface follows
...
```go
import "github.com/go-ruby-multi-json/multi-json"
```
...
- **[pkg.go.dev/github.com/go-ruby-multi-json/multi-json](https://pkg.go.dev/github.com/go-ruby-multi-json/multi-json)**

The module's [README](https://github.com/go-ruby-multi-json/multi-json#readme) carries worked
